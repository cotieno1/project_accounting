...
class MiscPurchaseOrder(models.Model):
    ...
    # BuildWatch misc variation link (Sprint 2 Addendum A)
    infra_project = models.ForeignKey(
    ...
    variation_ref = models.CharField(
        max_length=20,
        blank=True,
        default='',
    ...
    ceiling_locked = models.BooleanField(
        default=False,
    ...
    def save(self, *args, **kwargs):
        ...
        if self.infra_project_id and not self.variation_ref:
            existing = MiscPurchaseOrder.objects.filter(
                infra_project_id=self.infra_project_id,
...
# ====================================================================
# BuildWatch Addendum A — misc variation models
# ====================================================================


class MiscCompletionRecord(models.Model):
    """
    GRN-equivalent for self-executed misc variations.
    Senior Engineer sign-off before CashClearingRecord / GL close.
    """
...
class MiscVariation(models.Model):
    """
    Thin wrapper registering a MiscPurchaseOrder as a named BuildWatch variation.
    """
    mpo = models.OneToOneField(
        MiscPurchaseOrder,
        on_delete=models.PROTECT,
