...
ROLE_PERMISSIONS = {
    ...
    GENERAL_MANAGER: {PERM_GM_PAYMENTS, PERM_BID_EVALUATION, PERM_RO_AUTHOR, PERM_GM_SIGNATORY_COPIES, PERM_VIEW_ALL_PAYMENTS},
    CEO: {PERM_APPROVE_BUDGET, PERM_DISBURSE_FUNDS, PERM_BUDGET_VARIANCE_ALERTS, PERM_VIEW_ALL_PAYMENTS, PERM_EMAIL_CC_ALL, PERM_GM_SIGNATORY_COPIES},
}
