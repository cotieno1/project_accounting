...
Path("accounts/tests/test_bid_evaluation_gate.py").write_text(
...
from accounts.views import _bid_evaluation_gate
...
class BidEvaluationGateHelperTests(TestCase):
    ...
    def test_blocks_without_bom_ro_rfq(self):
        ...
        self.assertIn("not authorised", message.lower())
...
class BidEvaluationGateViewTests(TestCase):
    ...
    def test_page_shows_block_panel_without_prerequisites(self):
        ...
        self.assertContains(response, "Bid evaluation not available")
