...
buildwatch_patterns = [
    ...
    path('inception/list/',
         inception.inception_list,
         name='inception-list'),
    path('inception/<int:pk>/',
         inception.inception_workspace,
         name='inception-detail'),
    path('inception/<int:pk>/contribute/',
         inception.inception_contribute,
         name='inception-contribute'),
    path('inception/<int:pk>/upload/',
         inception.inception_upload,
         name='inception-upload'),
    path('inception/<int:pk>/invite/',
         inception.inception_invite,
         name='inception-invite'),
    path('inception/<int:pk>/accept/',
         inception.inception_accept,
         name='inception-accept'),
    path('inception/<int:pk>/submit-review/',
         inception.inception_submit_review,
         name='inception-submit-review'),
    path('inception/<int:pk>/approve/',
         inception.inception_approve,
         name='inception-approve'),
    path('inception/<int:pk>/pack/',
         inception.inception_pack,
         name='inception-pack'),
    path('inception/<int:pk>/budget/',
         inception.concept_budget,
         name='concept-budget'),
